...
public class ProblemReportingSystemTests
{
    ...
    [Fact]
    public async Task LinkToRequirementAsync_PhantomVerifiedTestFile_DoesNotSatisfyClose()
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedImplementationAsync(
            "TC-PHANTOM-001",
            "phantom/forgeTests.cs");
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover phantom test implementation evidence",
            changedBy: "bob");
    ...
    [Fact]
    public async Task UpdateStatusAsync_RejectsClosedCriticalWithPlaceholderRequirementNumber()
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedCodeAsync();
        forged.RequirementNumber = "n/a";
        await fixture.Requirements.SaveChangesAsync();
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover placeholder requirement number",
            changedBy: "bob");
    ...
    [InlineData("___")]
    [InlineData("123456789012")]
    public async Task UpdateStatusAsync_RejectsClosedCriticalWithPunctuationOnlyRequirementDescription(
        string leftoverDescription)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedCodeAsync();
        forged.Description = leftoverDescription;
        await fixture.Requirements.SaveChangesAsync();
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover punctuation-only requirement description",
            changedBy: "bob");
    ...
    [InlineData("___")]
    [InlineData("123456789012")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPunctuationOnlyRequirementDescription_FailsClosed(
        string leftoverDescription)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9017",
            Title = "Legacy closed critical",
            Description = "Closed against leftover punctuation-only requirement description",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
    ...
    [Fact]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPlaceholderRequirementNumber_FailsClosed()
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedCodeAsync();
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9005",
            Title = "Legacy closed critical",
            Description = "Closed against leftover placeholder requirement identity",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
    ...
    [InlineData("___")]
    [InlineData("---")]
    public async Task UpdateStatusAsync_RejectsClosedCriticalWithPunctuationOnlyRequirementNumber(
        string leftoverNumber)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedCodeAsync();
        forged.RequirementNumber = leftoverNumber;
        await fixture.Requirements.SaveChangesAsync();
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover punctuation-only requirement number",
            changedBy: "bob");
    ...
    [InlineData("___")]
    [InlineData("---")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPunctuationOnlyRequirementNumber_FailsClosed(
        string leftoverNumber)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9018",
            Title = "Legacy closed critical",
            Description = "Closed against leftover punctuation-only requirement identity",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
        ...
        string leftoverNumber)
    {
        ...
        matching.RequirementNumber = leftoverNumber;
        await fixture.Requirements.SaveChangesAsync();
        ...
        var leftover = new ProblemReport
        {
            ...
            Title = "Legacy closed critical",
            Description = "Closed against leftover numeric requirement identity",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
    ...
    [Fact]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithEmptyRequirementTitle_FailsClosed()
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedCodeAsync();
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9006",
            Title = "Legacy closed critical",
            Description = "Closed against leftover empty requirement title",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
            Resolution = "verified against leftover empty requirement title",
            CreatedAt = DateTime.UtcNow.AddDays(-2),
            ClosedAt = DateTime.UtcNow.AddDays(-1)
        };
        fixture.Reports.ProblemReports.Add(leftover);
    ...
    [InlineData("___")]
    [InlineData("123")]
    public async Task UpdateStatusAsync_RejectsClosedCriticalWithPunctuationOnlyRequirementTitle(
        string leftoverTitle)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedCodeAsync();
        forged.Title = leftoverTitle;
        await fixture.Requirements.SaveChangesAsync();
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover punctuation-only requirement title",
            changedBy: "bob");
    ...
    [InlineData("___")]
    [InlineData("123")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPunctuationOnlyRequirementTitle_FailsClosed(
        string leftoverTitle)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        var leftover = new ProblemReport
        {
            ...
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9018",
            Title = "Legacy closed critical",
            Description = "Closed against leftover punctuation-only requirement title",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
    ...
    [InlineData("none")]
    [InlineData("todo")]
    public async Task UpdateStatusAsync_RejectsClosedCriticalWithPlaceholderFunctionName(
        string leftoverFunctionName)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedCodeAsync();
        var codeLink = await fixture.Requirements.RequirementCodeLinks.SingleAsync();
        codeLink.FunctionName = leftoverFunctionName;
        await fixture.Requirements.SaveChangesAsync();
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover placeholder function name",
            changedBy: "bob");
    ...
    [InlineData("none")]
    [InlineData("todo")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPlaceholderFunctionName_FailsClosed(
        string leftoverFunctionName)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9009",
            Title = "Legacy closed critical",
            Description = "Closed against leftover placeholder function name",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
    ...
    [InlineData("___")]
    [InlineData("123")]
    public async Task UpdateStatusAsync_RejectsClosedCriticalWithPunctuationFunctionName(
        string leftoverFunctionName)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover punctuation function name",
            changedBy: "bob");
    ...
    [InlineData("___")]
    [InlineData("123")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPunctuationFunctionName_FailsClosed(
        string leftoverFunctionName)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9011",
            Title = "Legacy closed critical",
            Description = "Closed against leftover punctuation function name",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
    ...
    [Fact]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithNamedFunction_StillComplies()
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var matching = await fixture.SeedRequirementWithVerifiedCodeAsync();
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9010",
            Title = "Legacy closed critical",
            Description = "Closed against leftover named function implementation",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
            Resolution = "verified against leftover named function implementation",
            CreatedAt = DateTime.UtcNow.AddDays(-2),
            ClosedAt = DateTime.UtcNow.AddDays(-1)
        };
        fixture.Reports.ProblemReports.Add(leftover);
    ...
    public async Task UpdateStatusAsync_RejectsClosedCriticalWithPlaceholderCodeFile(
        string leftoverCodeFile)
    {
        ...
        var act = async () => await system.UpdateStatusAsync(
            created.ReportNumber,
            ProblemReportStatus.Closed,
            resolution: "verified against leftover placeholder code path",
            changedBy: "bob");
    ...
    [InlineData("Core/n/a.cs")]
    [InlineData("Core/todo.cs")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPlaceholderCodeFile_FailsClosed(
        string leftoverCodeFile)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        var leftover = new ProblemReport
        {
            ...
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9011",
            Title = "Legacy closed critical",
            Description = "Closed against leftover placeholder code path",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
    ...
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPlaceholderCoverageTestFile_FailsClosed(
        string leftoverTestFile)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        await fixture.SeedCoverageTestAsync("TC-NA-001", leftoverTestFile);

        var leftover = new ProblemReport
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9012",
            Title = "Legacy closed critical",
            Description = "Closed against leftover placeholder coverage test file",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
            Resolution = "verified against leftover placeholder coverage test file",
            CreatedAt = DateTime.UtcNow.AddDays(-2),
            ClosedAt = DateTime.UtcNow.AddDays(-1)
        };
        fixture.Reports.ProblemReports.Add(leftover);
    ...
    [InlineData("none")]
    [InlineData("todo")]
    public async Task LinkToTestAsync_RejectsPlaceholderCoverageInventory(string placeholderTestCaseId)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        await fixture.SeedCoverageTestAsync(placeholderTestCaseId, "Tests/Coverage/SensorTests.cs");
        ...
        var act = async () => await system.LinkToTestAsync(created.ReportNumber, placeholderTestCaseId);
        await act.Should().ThrowAsync<ArgumentException>()
            .WithMessage("*Test case*not found*");
    }
    ...
    [InlineData("none")]
    [InlineData("todo")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPlaceholderCoverageTest_FailsClosed(
        string leftoverTestCaseId)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        await fixture.SeedCoverageTestAsync(leftoverTestCaseId, "Tests/Coverage/SensorTests.cs");

        var leftover = new ProblemReport
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9105",
            Title = "Legacy closed critical",
            Description = "Closed against leftover placeholder coverage inventory",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
            Resolution = "verified against leftover placeholder coverage inventory",
            CreatedAt = DateTime.UtcNow.AddDays(-2),
            ClosedAt = DateTime.UtcNow.AddDays(-1)
        };
        fixture.Reports.ProblemReports.Add(leftover);
    ...
    [InlineData("___")]
    [InlineData("123")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPunctuationOnlyVerifiedTest_FailsClosed(
        string leftoverTestCaseId)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        var forged = await fixture.SeedRequirementWithVerifiedImplementationAsync(leftoverTestCaseId);

        var leftover = new ProblemReport
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9107",
            Title = "Legacy closed critical",
            Description = "Closed against leftover punctuation-only verified test identity",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
            Resolution = "verified against leftover punctuation-only verified test identity",
            CreatedAt = DateTime.UtcNow.AddDays(-2),
            ClosedAt = DateTime.UtcNow.AddDays(-1)
        };
        fixture.Reports.ProblemReports.Add(leftover);
    ...
    [InlineData("___")]
    [InlineData("123")]
    public async Task VerifyComplianceAsync_LeftoverClosedCriticalWithPunctuationOnlyCoverageTest_FailsClosed(
        string leftoverTestCaseId)
    {
        await using var fixture = CreateFixture();
        var system = fixture.System;
        ...
        {
            Id = Guid.NewGuid(),
            ReportNumber = $"PR-{DateTime.UtcNow.Year}-9106",
            Title = "Legacy closed critical",
            Description = "Closed against leftover punctuation-only coverage inventory",
            Impact = "critical safety instrumentation fault",
            Severity = ProblemSeverity.Critical,
            Status = ProblemReportStatus.Closed,
            ReportedBy = "alice",
            Resolution = "verified against leftover punctuation-only coverage inventory",
            CreatedAt = DateTime.UtcNow.AddDays(-2),
            ClosedAt = DateTime.UtcNow.AddDays(-1)
        };
        fixture.Reports.ProblemReports.Add(leftover);
    ...
    private sealed class ProblemReportFixture : IAsyncDisposable
    {
        ...
        public async Task<Requirement> SeedRequirementWithVerifiedImplementationAsync(
            string testCaseId,
            string testFile = "Tests/Unit/Sensors/ChamberPressureTests.cs")
        {
            var requirement = new Requirement
